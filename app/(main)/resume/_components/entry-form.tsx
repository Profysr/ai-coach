...
const formatDisplayDate = (dateString: string) => {
  ...
  console.log("DateString before parsing", dateString);

  const date = parse(dateString, "yyyy-MM", new Date());
  console.log("Datestring after parsing", date);
...
const EntryForm = ({
  ...
  // console.log("Current Watching in Entry Form", current);
  ...
  useEffect(() => {
    if (improvedContent?.data && !isImproving) {
